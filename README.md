...
- `--udp-dport-filter=<5,6,200-500>` Filter the UDP destination ports. Defaults to no ports. Specifie the ports you want to be handled by dpiDisabler.
...
YoutubeUnblock may also run on Padavan. [Check the manual here\[rus\]](Padavan.md)
 ...
 >If you have any questions/suggestions/problems feel free to open an [issue](https://github.com/Waujito/dpiDisabler/issues).
